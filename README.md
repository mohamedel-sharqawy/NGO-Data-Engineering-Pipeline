...
`00_config` ➡️ `01_bronze` ➡️ `02_silver` ➡️ `03_gold`

---

## 🧪 Automated Data Quality Assertions (`gold_quality_summary`)

Data quality is programmatically checked in the Silver transformation phase and stored in `gold_quality_summary`:
...
| `null_service_ids` | `silver_services` | Verifies `service_id IS NOT NULL` |
